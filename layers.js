    ...
    layer.on({
        click:
            function populate() {
                ...
                sidebar.setContent("<a class='example-image-link' href=" + foto + " data-lightbox='image1' data-title=" + lugar + "><img height='200' src=" + foto + " style='cursor:zoom-in'></a>" + "<br>LUGAR: " + feature.properties.name + "<br>FREGUESIA: " + feature.properties.FREGUESIA + "<br>PAINEL: " + feature.properties.PAINEL + "<br> DESCRIÇÃO DO ORATÓRIO: " + feature.properties["DESCRIÇÃO DO ORATÓRIO"] + "<br><br>" + obs);
